...
const App = () => {
  ...
  const getAllBooks = () => {
    axios.get('https://git.heroku.com/bibliostats.git/api/getBooks')
      .then(results => {
  ...
  const searchBooks = (query) => {
    axios.get(`https://git.heroku.com/bibliostats.git/api/search/${query}`)
  ...
  const addBook = (e) => {
    ...
    axios.post('//https://git.heroku.com/bibliostats.git/api/addToShelf', bookToAdd)
      .then(() => getAllBooks())
  }
  ...
  const editBookDetails = (id, status, dateStarted, dateFinished, format, rating) => {
    ...
    axios.patch(`https://git.heroku.com/bibliostats.git/api/editBookDetails/${id}`, update)
  ...
  const editBookReview = (id, review) => {
    ...
    axios.patch(`https://git.heroku.com/bibliostats.git/api/editBookReview/${id}`, update)
      .then((book) => setSelectedBook(book.data[0]))
      .then(() => getAllBooks())
  }
  ...
  const editBookNotes = (id, notes) => {
    ...
    axios.patch(`https://git.heroku.com/bibliostats.git/api/editBookNotes/${id}`, update)
      .then((book) => setSelectedBook(book.data[0]))
      .then(() => getAllBooks())
  }

  const deleteBook = (id) => {
    axios.delete(`https://git.heroku.com/bibliostats.git/api/deleteBook/${id}`)
